		...
		login: function login(cb) {
			...
			(0, _getGithubAuthToken2.default)(function (err, token) {
				...
				_github2.default.user.get({}, function (err, user) {
					...
					if (cb) cb(true);
					_this.onChange(true, JSON.parse(sessionStorage.getItem("user")));
				});
			});
		},
	...
	var Repo = function (_React$Component) {
		...
		function Repo(props) {
			...
			_this.repoData = function () {
				var data = sessionStorage.getItem("repo__" + _this.repoName());
			...
			_this.cloneRepo = function () {
				...
				(0, _git.cloneRepo)(_this.props.repo.html_url, path, function (err, res) {
					...
					sessionStorage.setItem("repo__" + _this.repoName(), JSON.stringify({ path: res.path }));
				});
			};
...
/***/ function(module, exports) {
	...
	function cloneRepo(url, path, cb) {
		...
		var GITHUB_TOKEN = window.sessionStorage.getItem("token");
