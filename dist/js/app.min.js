	...
	var Repo = function (_React$Component) {
		...
		function Repo(props) {
			...
			_this.cloneRepo = function () {
				...
				var path = window.require('path').join("/Users/rista/repos/", _this.props.repo.owner.login + ":" + _this.props.repo.name);
				(0, _git.cloneRepo)(_this.props.repo.html_url, path);
		...
		_createClass(Repo, [{
			...
			value: function render() {
				...
				var isCloned = this.state.isCloned ? 'Repo--isCloned' : '';
	
				return _react2.default.createElement(
					'div',
					{ className: "Repo " + isCloned },
					_react2.default.createElement(
						'h2',
					...
					_react2.default.createElement(
						...
						' ',
						this.state.path || "clone repository →",
						' '
					)
				);
			}
