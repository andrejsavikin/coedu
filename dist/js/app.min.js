...
/***/ function(module, exports, __webpack_require__) {
	...
	var _auth = __webpack_require__(/*! ./auth.jsx */ 216);
	
	var _auth2 = _interopRequireDefault(_auth);
	
	var _routeHooks = __webpack_require__(/*! ./routeHooks.jsx */ 219);
	
	var _App = __webpack_require__(/*! ./components/App.jsx */ 220);
	
	var _App2 = _interopRequireDefault(_App);
	
	var _Login = __webpack_require__(/*! ./components/Login.jsx */ 222);
	
	var _Login2 = _interopRequireDefault(_Login);
	
	var _ReposList = __webpack_require__(/*! ./components/ReposList.jsx */ 224);
	
	var _ReposList2 = _interopRequireDefault(_ReposList);
	
	var _SingleRepo = __webpack_require__(/*! ./components/SingleRepo.jsx */ 227);
	
	var _SingleRepo2 = _interopRequireDefault(_SingleRepo);
	...
	(0, _reactDom.render)(_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_reactRouter.IndexRoute, { component: _Login2.default, onEnter: _routeHooks.isLoggedIn }),
			_react2.default.createElement(_reactRouter.Route, { path: '/repos', component: _ReposList2.default, onEnter: _routeHooks.requireAuth }),
			_react2.default.createElement(_reactRouter.Route, { path: '/repo/:user/:repo', component: _SingleRepo2.default, onEnter: _routeHooks.requireAuth })
		)
	), document.getElementById('app')); // Core
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getGithubAuthToken = __webpack_require__(/*! ./getGithubAuthToken.js */ 217);
	
	var _getGithubAuthToken2 = _interopRequireDefault(_getGithubAuthToken);
	
	var _github = __webpack_require__(/*! ./github.js */ 218);
	...
	var remote = _window$require.remote;
	var shell = _window$require.shell;
	
	var reposPath = window.require('path').join(remote.getGlobal("__dirname"), "../repos");
	...
	var Auth = {
		login: function login(cb) {
			...
			(0, _getGithubAuthToken2.default)(function (err, token) {
				if (err) throw err;
				...
				// Get user info
				_github2.default.user.get({}, function (err, user) {
					if (err) throw err;
					...
					if (cb) cb(true);
					_this.onChange(true, JSON.parse(localStorage.getItem("user")));
				});
			});
		},
...
/* 217 */
/*!******************************************!*\
  !*** ./src/client/getGithubAuthToken.js ***!
  \******************************************/
/***/ function(module, exports) {
	...
	exports.default = getGithubAuthToken;
	...
	function getGithubAuthToken(callback) {
		...
		var handleCallback = function handleCallback(url) {
...
/***/ function(module, exports) {
	...
	var GitHubApi = window.require("github");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.isLoggedIn = exports.requireAuth = undefined;
	...
	var requireAuth = exports.requireAuth = function requireAuth(nextState, replace) {
		if (!_auth2.default.loggedIn()) replace({ pathname: '/' });else _auth2.default.auth();
	};
	
	var isLoggedIn = exports.isLoggedIn = function isLoggedIn(nextState, replace) {
		if (_auth2.default.loggedIn()) replace({ pathname: '/repos' });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Footer = __webpack_require__(/*! ./Footer.jsx */ 221);
	...
	var App = function (_React$Component) {
		...
		_createClass(App, [{
			key: 'updateAuth',
			value: function updateAuth(loggedIn, user) {
				this.setState({
					loggedIn: loggedIn,
					user: user
				});
			...
			value: function render() {
				return _react2.default.createElement(
					...
					{ className: 'App View' },
					this.props.children,
					_react2.default.createElement(_Footer2.default, { user: this.state.user, loggedIn: this.state.loggedIn })
				);
			}
		}]);
			...
			value: function render() {
				...
				if (this.props.loggedIn) return _react2.default.createElement(
					...
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: '/' },
						_react2.default.createElement('img', { onClick: this.handleLogout, className: 'logout', src: "images/logout.svg" })
					),
					_react2.default.createElement(
						'span',
						{ className: 'user-info' },
				...
				);else return _react2.default.createElement('footer', null);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GithubButton = __webpack_require__(/*! ./GithubButton.jsx */ 223);
	...
	var Login = function (_React$Component) {
		...
		_createClass(Login, [{
			...
			value: function handleLogin() {
				// Refactor
				_auth2.default.login(function (response) {
					return location.href = "#/repos";
				});
			}
		}, {
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement('img', { className: 'OctocatImage', src: "./images/octobiwan.jpg" }),
					_react2.default.createElement(_GithubButton2.default, { cta: 'Sign In', handleClick: this.handleLogin }),
					_react2.default.createElement(
						'small',
						null,
						'alpha version'
...
/* 223 */
/*!************************************************!*\
  !*** ./src/client/components/GithubButton.jsx ***!
  \************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var GithubButton = function (_React$Component) {
		...
		function GithubButton() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(GithubButton).apply(this, arguments));
		}
		...
		_createClass(GithubButton, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'GithubButton', onClick: this.props.handleClick },
					_react2.default.createElement('img', { className: 'GithubButton__Icon', src: "images/github-white.svg" }),
					_react2.default.createElement(
						'span',
						{ className: 'GithubButton__Text' },
						this.props.cta
					)
				);
			}
...
/* 224 */
/*!*********************************************!*\
  !*** ./src/client/components/ReposList.jsx ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _Repo = __webpack_require__(/*! ./Repo.jsx */ 225);
	...
	var ReposList = function (_React$Component) {
		...
		function ReposList() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ReposList)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
				repos: [],
				loaded: false
			}, _this.fetchRepos = function () {
				_this.setState({ loaded: false });
				_github2.default.repos.getAll({ sort: "updated", type: "owner" }, function (err, repos) {
		...
		_createClass(ReposList, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ onClick: this.fetchRepos, className: 'ReposList__refresh' },
						_react2.default.createElement('img', { src: 'images/refresh.svg' }),
						' '
					),
					_react2.default.createElement(
						'div',
						{ className: 'Repos' },
						this.state.loaded ? this.state.repos.sort(function (a, b) {
...
/* 225 */
/*!****************************************!*\
  !*** ./src/client/components/Repo.jsx ***!
  \****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _git = __webpack_require__(/*! ../git.jsx */ 226);
	...
	var Repo = function (_React$Component) {
		...
		function Repo(props) {
			...
			_this.repoName = function () {
				return _this.props.repo.owner.login + "/" + _this.props.repo.name;
			};
	
			_this.repoData = function () {
				var data = localStorage.getItem("repo__" + _this.repoName());
	
				if (data) return JSON.parse(data);
			};
	
			_this.cloneRepo = function () {
	
				// Cancel if already cloned
				if (_this.state.isCloned || _this.repoData()) return;
				...
				var repoPath = window.require('path').join(remote.getGlobal("__dirname"), "../repos", _this.repoName());
	
				// Clone repo
				(0, _git.cloneRepo)(_this.props.repo.html_url, repoPath, function (err, res) {
					if (err) {
						console.error(err);
						return;
					}
					...
					localStorage.setItem("repo__" + _this.repoName(), JSON.stringify({ directory_path: res.path }));
				});
			};
		...
		_createClass(Repo, [{
			...
			value: function render() {
				...
				var repoMeta = path || (cloning ? "cloning..." : "clone repository →");
				var repoName = this.repoName().toString();
	
				console.log("ime", repoName);
	
				return _react2.default.createElement(
					'div',
					{ className: "Repo " + (isCloned ? 'Repo--isCloned' : '') },
					isCloned ? _react2.default.createElement(
						'h2',
					...
					_react2.default.createElement(
						'small',
						{ className: 'Repo__Meta', onClick: this.cloneRepo },
						' ',
						repoMeta,
						' '
					)
...
/***/ function(module, exports, __webpack_require__) {
	...
	function cloneRepo(url, path, cb) {
	
		var GITHUB_TOKEN = window.localStorage.getItem("token");
		...
		Git.Clone(url, path, cloneOptions).catch(function (err) {
			console.log(err);
			if (cb) cb(err, null);
			...
			if (cb) cb(null, { repository: repository, path: path });
		});
	
		return repo;
	}
	
	function addAndCommit(repo, path, message) {
	
		var index = void 0;
		var oid = void 0;
		return repo.index().then(function (indexResult) {
			index = indexResult;
		}).then(function () {
			return index.addAll();
		}).then(function () {
			...
			var author = Git.Signature.now(user.name, user.email);
...
/* 227 */
/*!**********************************************!*\
  !*** ./src/client/components/SingleRepo.jsx ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _github = __webpack_require__(/*! ../github */ 218);
	...
	var SingleRepo = function (_React$Component) {
		_inherits(SingleRepo, _React$Component);
		...
		function SingleRepo() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SingleRepo)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
				repo: null,
				loaded: false,
				lastCommit: "",
				isDirty: false,
				...
				return _this.props.params.user + "/" + _this.props.params.repo;
			}, _this.init = function () {
				_this.getRepo(function () {
					_this.getLastCommit();
					_this.getStatus();
			...
			}, _this.repo = null, _this.getRemote = function (cb) {
				_this.repo.getRemote("origin").then(function (remote) {
					cb(remote);
				});
			}, _this.pushToRemote = function () {
				_this.getRemote(function (remote) {
					remote.push(["refs/heads/master:refs/heads/master"], {
						callbacks: {
							credentials: function credentials(url, userName) {
								return Git.Cred.userpassPlaintextNew(_auth2.default.getToken(), "x-oauth-basic");
							}
						}
					}).then(function (message) {
						return console.log(message);
					}).then(function () {
						_this.modifyHasCommits(false, function () {
							return _this.init();
						});
					});
				});
			}, _this.getRepo = function (cb) {
				Git.Repository.open(_this.repoData().directory_path).then(function (repository) {
				...
				if (data) return JSON.parse(data);
			}, _this.getLastCommit = function () {
				_this.repo.getHeadCommit().then(function (commit) {
					_this.setState({ lastCommit: commit.message() });
				});
			}, _this.getStatus = function () {
				_this.repo.getStatus().then(function (status) {
					if (status.length) {
						_this.setState({ isDirty: true });
					}
				});
			}, _this.modifyHasCommits = function (bool, cb) {
				var updatedData = JSON.stringify(Object.assign(_this.repoData(), { hasCommits: bool }));
				localStorage.setItem("repo__" + _this.repoName(), updatedData);
				if (cb) cb();
			}, _this.handleAddAndCommit = function (commitMessage) {
				if (_this.state.isDirty) {
					(0, _git.addAndCommit)(_this.repo, _this.repoData().directory_path, commitMessage).then(function (commitId) {
						_this.modifyHasCommits(true, function () {
							return _this.init();
						});
			...
			}, _this.openPublicRepo = function () {
				var repoWindow = new BrowserWindow({ width: 1024, height: 768, show: false, 'node-integration': false });
				repoWindow.loadURL(_this.state.repo.html_url);
				repoWindow.show();
				// Reset the authWindow on close
				...
				if (e.key === 'Enter' && _this.refs.commitMessage.value !== '') {
					var commitMessage = _this.refs.commitMessage.value;
					_this.refs.commitMessage.value = '';
					_this.setState({ showMessageInput: false });
					_this.handleAddAndCommit(commitMessage);
				}
			}, _this.handleCommitButtonPress = function () {
				if (_this.state.isDirty) {
					_this.setState({ showMessageInput: true });
					setTimeout(function () {
						return _this.refs.commitMessage.focus();
					}, 5);
				}
			}, _temp), _possibleConstructorReturn(_this, _ret);
		}
		...
		_createClass(SingleRepo, [{
			...
			value: function componentWillMount() {
				...
				if (!this.repoData.owner) {
					_github2.default.repos.get({ user: this.props.params.user, repo: this.props.params.repo }, function (err, repo) {
	
						if (err) {
							_this2.setState({ loaded: true, errorMessage: err.message });
							throw err;
							return;
						}
	
						var fullRepo = Object.assign(repo, JSON.parse(localStorage.getItem("repo__" + _this2.repoName())));
	
						localStorage.setItem("repo__" + _this2.repoName(), JSON.stringify(fullRepo));
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					this.state.loaded ? _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement('img', { onClick: this.init, className: 'SingleRepo__refresh', src: 'images/refresh.svg' }),
						_react2.default.createElement(
							'h2',
							{ className: 'SingleRepo__name' },
							_react2.default.createElement(
								'span',
								{ className: 'SingleRepo__go-back', onClick: this.goBack },
								'←'
							),
						...
						_react2.default.createElement(
							'section',
							{ className: 'SingleRepo__meta' },
							_react2.default.createElement(
								'span',
								{ className: 'SingleRepo__path' },
								' ',
								this.state.repo.directory_path,
								' '
							),
							_react2.default.createElement(
								'span',
								{ className: 'SingleRepo__helpers' },
								this.state.repo.private ? _react2.default.createElement('img', { className: 'SingleRepo__private-icon', src: 'images/octicon.svg' }) : "",
								_react2.default.createElement(
									'a',
									{ className: 'SingleRepo__external-link', onClick: this.openPublicRepo },
									_react2.default.createElement('img', { src: "images/planet.svg" })
								)
							)
						),
						_react2.default.createElement(
							'section',
							{ className: 'SingleRepo__last-commit' },
							_react2.default.createElement(
								'p',
								null,
								_react2.default.createElement(
									'span',
									{ className: 'SingleRepo__last-commit-text' },
									'Last commit:'
								),
								' ',
						...
						_react2.default.createElement(
							'section',
							{ className: 'SingleRepo__actions' },
							this.state.showMessageInput && _react2.default.createElement('input', { onKeyPress: this.handleKeyPress, placeholder: 'Commit message here..', className: 'SingleRepo__messageInput', ref: 'commitMessage' }),
							_react2.default.createElement(
								'div',
								{ onClick: this.handleCommitButtonPress, className: "SingleRepo__action " + (this.state.isDirty ? "active" : "") },
								_react2.default.createElement('img', { src: 'images/add-icon.svg' }),
								_react2.default.createElement(
									'pre',
									null,
									'git commit'
							...
							_react2.default.createElement(
								'div',
								{ onClick: this.pushToRemote, className: "SingleRepo__action " + (this.repoData().hasCommits ? "active" : "") },
								_react2.default.createElement('img', { src: 'images/push-icon.svg' }),
								_react2.default.createElement(
									'pre',
									null,
									'git push'
						...
						_react2.default.createElement(
							'section',
							{ className: 'SingleRepo__shortcuts' },
							_react2.default.createElement(
								'div',
								{ onClick: function onClick() {
										shell.openItem(_this3.state.repo.directory_path);
									} },
								_react2.default.createElement('img', { src: 'images/folder.svg' }),
								_react2.default.createElement(
									'pre',
									null,
									'explore repo'
