		...
		function SingleRepo() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SingleRepo)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
				...
				_this.getRepo(function () {
					_this.getLastCommit();
					_this.getStatus();
					if (_this.repo.headDetached()) {
						_this.setState({ hasCommits: true });
					}
				});
			}, _this.repo = null, _this.getRepo = function (cb) {
				...
				return _react2.default.createElement(
					...
					this.state.loaded ? _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: "SingleRepo__action " + (this.state.hasCommits ? "active" : "") },
