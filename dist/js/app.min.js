	...
	var SingleRepo = function (_React$Component) {
		...
		function SingleRepo() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SingleRepo)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
				...
				if (cb) cb();
			}, _this.handleAddAndCommit = function () {
				if (_this.state.isDirty) {
					(0, _git.addAndCommit)(_this.repo, _this.repoData().directory_path, "Jos fali za poruku").then(function (commitId) {
				...
				return _react2.default.createElement(
					...
					this.state.loaded ? _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ onClick: this.handleAddAndCommit, className: "SingleRepo__action " + (this.state.isDirty ? "active" : "") },
