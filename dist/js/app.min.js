		...
		_createClass(Login, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_GithubButton2.default, { cta: 'Sign In', clickMethod: this.handleClick })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GithubButton = function (_React$Component) {
		...
		_createClass(GithubButton, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'GithubButton', onClick: this.props.clickMethod },
	...
	GithubButton.propTypes = {
		...
		clickMethod: _react2.default.PropTypes.func.isRequired
	};
	...
	var ReposList = function (_React$Component) {
		...
		function ReposList() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ReposList)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
				data: [{ id: 0, name: "Cactomain", url: "https://github.com/vanjek/cactomain", path: "~/coedu/learning-git/" }, { id: 1, name: "Learning Git", url: "https://github.com/vanjek/learning" }, { id: 2, name: "Coedu Electron App", url: "https://github.com/rista404/coedu", path: "~/coedu/core/" }, { id: 3, name: "teslabg/maturski", url: "https://github.com/teslabg/maturski" }]
	...
	var Repo = function (_React$Component) {
		...
		_createClass(Repo, [{
			...
			value: function render() {
				...
				var url = repo.path ? repo.path : "clone repository →";
