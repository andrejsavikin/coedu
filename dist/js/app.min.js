		...
		function Repo(props) {
			...
			_this.cloneRepo = function () {
				...
				(0, _git.cloneRepo)(_this.props.repo.html_url, repoPath, function (err, res) {
					...
					localStorage.setItem("repo__" + _this.repoName(), JSON.stringify({ path: res.path }));
				});
			};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SingleRepo = function (_React$Component) {
		...
		function SingleRepo() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(SingleRepo).apply(this, arguments));
		}
